  ...
  return (
    <div className="min-h-[100dvh] flex flex-col bg-background relative overflow-hidden">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 relative z-10">
        <div className="w-24 h-24 rounded-[2rem] shadow-2xl mb-8 rotate-12 transition-transform hover:rotate-0 duration-500 overflow-hidden">
          <img src="/eagle-logo.jpeg" alt="Silver Stream Logo" className="w-full h-full object-cover" />
        </div>
